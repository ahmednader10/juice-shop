...
function createAll(callback) {
  createChallenges(callback)
  createUsers(callback)
  createRandomFakeUsers(callback)
  createProducts(callback)
  createBaskets(callback)
  createFeedback(callback)
  createComplaints(callback)
  createRecycles(callback)
  createSecurityQuestions(callback)
  createSecurityAnswers(callback)
}

var count = 0;

function createChallenges (callback) {
...
function createRandomFakeUsers (callback) {
...
function createBaskets (callback) {
...
function createComplaints (callback) {
...
function createRecycles (callback) {
...
function createSecurityQuestions (callback) {
...
function createSecurityAnswers (callback) {
